...
export default class OverView extends  Laya.Sprite{
    ...
    private thisDisplay1: ui.game.GameOverSkin1UI;
    private thisDisplay2: ui.game.GameOverSkin2UI;
    private thisDisplay3: ui.game.GameOverSkin3UI;
   ...
   // private myConncet: iugame.MyConnect; 
    ...
    public openUI(data){
        this.thisDisplay1 = new ui.game.GameOverSkin1UI();
