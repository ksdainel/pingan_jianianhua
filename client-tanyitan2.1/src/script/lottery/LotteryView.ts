...
import RuleView from "./LotteryRuleView";
export default class LotteryView extends  Laya.Sprite{
    public constructor(parent) {
        super();
        this.thisDisplay = new ui.lottery.LotteryViewSkinUI();
    ...
    private thisDisplay: ui.lottery.LotteryViewSkinUI;
